...
def read_distance(i2c):
    ...
    time.sleep_ms(60)
    d = (i2c.readfrom_mem(ADDR_TOF, 0x14, 12)[10] << 8) | i2c.readfrom_mem(ADDR_TOF, 0x14, 12)[11]
...
while True:
    ...
    if time.time() - last_send > SEND_INTERVAL:
        send("EU6EE36IJ7WSVYP3", {
            "field1": tA_amb, "field2": als_A, "field3": d_A,
            "field4": tA_air, "field5": tA_wat,
            "field6": lux_A, "field7": ir_A
        })
        send("E8CTAK8MCUWLQJ2", {
            "field1": uv_B, "field2": d_B,
            "field3": tB_air, "field4": tB_wat,
            "field6": lux_B, "field7": ir_B
        })
        send("Y1FWSOX7Z6YZ8QMU", {
            "field1": uv_C, "field2": d_C,
            "field3": tC_air, "field4": tC_wat,
            "field5": lux_C, "field6": ir_C
        })
        last_send = time.time()
